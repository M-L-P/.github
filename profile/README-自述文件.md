...
Yours-UEFI|Y-o-u-r-s,<br/>Your own usual rEFInd's sign for UEFI firmware.|能够在安全启动模式开启的情况下，加载 Clover 或 OpenCore 进而启动黑苹果|作为一个主菜单，管理 安装在你的电脑上的操作系统的 启动引导器|[Consult](https://github.com/M-L-P/Yours-UEFI)
